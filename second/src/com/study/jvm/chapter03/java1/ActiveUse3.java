 ...
 * <p>
 * 4. 当使用java.lang.reflect包中的方法反射类的方法时。比如：Class.forName("com.study.java.Test")
...
public class ActiveUse3 {
    ...
    public void test1() {
        try {
            Class clazz = Class.forName("com.study.jvm.chapter03.java1.Order"); // 主动使用
    ...
    @Test
    public void test2() {
        System.out.println(Son.num);  // 主动使用
    }

    @Test
    public void test3(){
        System.out.println(CompareC.NUM1);  // 主动使用
    }
